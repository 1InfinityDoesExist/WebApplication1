		...
		<div class="container">
			<form action="up" method="post">
				...
				User Name : <input type="text" class="form-control" name="userName"
					id="text2" placeholder="userName" title="Provide Your userName"
					required /> User Password : <input type="text"
					class="form-control" name="userPassword" id="text3"
					placeholder="userPassword" title="Provide Your userPassword"
					required /> <input type="submit" class="btn btn-info"
					Value="Submit" />
			</form>
		</div>
